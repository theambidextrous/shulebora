    ...
    <div class="row page-titles">
        ...
        <div class="col-md-5 col-12 align-self-center">
            ...
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active">Topical Questions</li>
            ...
            <div class="d-flex mt-2 justify-content-end">
                ...
                <div class="d-flex mr-3 ml-2">
                    ...
                    <div class="chart-text mr-2">
                        ...
                        <a href="#" data-toggle="modal" data-target="#new_Assignment_modal" class="btn btn-info"><i class="mdi mdi-library-plus"></i> Add Topical Question</a>
    ...
    <div class="container-fluid">
                ...
                <div class="card blog-widget">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div><h3 class="card-title">{{$p_title??'All Topical Questions'}}</h3></div>
                        ...
                        <div class="row">
                            ...
                            <div class="card-body" style="width:100%!important;">
                                ...
                                <h6 class="card-subtitle">List of all Topical Questions accross all subjects</a></h6>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table style="width:100%!important;" id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            ...
                                            @php($kind = ($assignment['is_paid']==1)?'PAID':'FREE')

                                            <tr>

                                                <td>{{App\User::find($assignment['created_by'])->name}}</td>

                                                <td>{{App\Subject::find($assignment['subject'])->name}}</td>

                                                <td>{{$assignment['title']}}</td>

                                                <td>{{$kind}}</td>

                                                <td><a href="{{ url('shule/bora/admin/assignments/' . $assignment['id']) }}" class="btn btn-link"><i class="mdi mdi-table-edit"></i>Manage</a></td>
        ...
        <div id="new_Assignment_modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="floating-labels mt-4" enctype="multipart/form-data" method="POST" action="{{ route('admin.add_assignment') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <label for="content">Topical Question </label>

                                        <textarea style="background: #e6e2e2;" rows="7" name="content" class="form-control @error('content') is-invalid @enderror" id="content"></textarea>
