            ...
            <div class="d-flex mt-2 justify-content-end">
                <div class="d-flex mr-3 ml-2">
                    <div class="chart-text mr-2">
                        <a href="#" data-toggle="modal" data-target="#new_Assignment_modal" class="btn btn-info"><i class="mdi mdi-library-plus"></i> Add Assignment</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card blog-widget">
                    <div class="card-body">
                        <div class="d-flex flex-wrap">
                            <div><h3 class="card-title">{{$p_title??'All Assignments'}}</h3></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="card-body" style="width:100%!important;">
                                <h6 class="card-subtitle">List of all Assignments accross all subjects</a></h6>
