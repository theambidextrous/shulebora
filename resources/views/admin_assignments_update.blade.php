    ...
    <div class="row page-titles">
        ...
        <div class="col-md-5 col-12 align-self-center">
            ...
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.assignments') }}">Topical Questions</a></li>
            ...
            <div class="d-flex mt-2 justify-content-end">
                ...
                <div class="d-flex mr-3 ml-2">
                    ...
                    <div class="chart-text mr-2">
                        ...
                        <a href="{{ route('admin.assignments') }}" class="btn btn-info"><i class="mdi mdi-library-plus"></i> Topical Questions</a>
                ...
                <div class="card blog-widget">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div><h3 class="card-title">Manage Topical Questions</h3></div>
                            ...
                            <div class="card-body" style="width:100%!important;">
                                ...
                                <ul class="nav nav-tabs mb-3">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <a href="#home" data-toggle="tab" aria-expanded="false" class="nav-link active">
                                            ...
                                            <span class="d-none d-lg-block">Edit Topical Question</span>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane show active" id="home">
                                        ...
                                        <form class="floating-labels mt-4" enctype="multipart/form-data" method="POST" action="{{ route('admin.update_assignment', ['id'=>$assignment['id']]) }}">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-5">
                                                    ...
                                                    <select name="teacher" id="teacher" class="form-control select2 no-float" autofocus >
                                                        ...
                                                        @if($assignment['created_by'] == $trc['id'])
