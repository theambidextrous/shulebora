            ...
            <div class="d-flex mt-2 justify-content-end">
                <div class="d-flex mr-3 ml-2">
                    <div class="chart-text mr-2">
                        <a href="#" data-toggle="modal" data-target="#new_form_modal" class="btn btn-info"><i class="mdi mdi-library-plus"></i> Add Form</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
                ...
                <div class="card blog-widget">
                    <div class="card-body">
                        ...
                        <div class="list-group"> 
                            ...
                            <a href="{{ route('admin.forms') }}" class="list-group-item active">All Forms</a>
                ...
                <div class="card blog-widget">
                    <div class="card-body">
                        <div class="d-flex flex-wrap">
                            <div><h3 class="card-title">All Forms</h3></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="card-body" style="width:100%!important;">
                                <h6 class="card-subtitle">List of all forms. i.e. Form 1, Form 2, Form 3 e.t.c</a></h6>
                                <div class="table-responsive">
                                    <table style="width:100%!important;" id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            ...
                                            @php($status = ($form['is_active'] == 1) ? 'Active':'Inactive')
                                            <tr>
                                                <td>{{$form['id']}}</td>
                                                <td>{{$form['name']}}</td>
                                                <td>{{ \App\Group::find($form['group'])->name }}</td>
                                                <td>{{$status}}</td>
                                                <td><a href="{{ url('shule/bora/admin/forms/' . $form['id']) }}" class="btn btn-link"><i class="mdi mdi-table-edit"></i>Manage</a></td>
                                            </tr>
                                            @endforeach
                                            @endif
                                        </tbody>
        ...
        <div id="new_form_modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form class="floating-labels mt-4" method="POST" action="{{ route('admin.add_form') }}">
                            @csrf
                            <div class="form-group mb-4">
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" data-toggle="tooltip"
                                    data-placement="bottom" title="Form name here" value="{{ old('name') }}" required autocomplete="name" autofocus="name">
                                <span class="bar"></span>
                            ...
                            <div class="form-group mb-4">
                                <input type="text" name="alias" class="form-control @error('alias') is-invalid @enderror" id="alias" data-toggle="tooltip"
                                    data-placement="bottom" title="Alias e.g. F1" value="{{ old('alias') }}" required autocomplete="alias" autofocus="alias">
                                <span class="bar"></span>
