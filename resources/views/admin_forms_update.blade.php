    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            ...
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.forms') }}">Forms</a></li>
                ...
                <div class="card blog-widget">
                    <div class="card-body">
                        <div class="d-flex flex-wrap">
                            <div><h3 class="card-title">Update Form</h3></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="card-body" style="width:100%!important;">
                                <div class="table-responsive">
                                    <form class="floating-labels mt-4" method="POST" action="{{ route('admin.update_form', ['id'=>$form['id']]) }}">
                                        @csrf
                                        <div class="form-group mb-4">
                                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" data-toggle="tooltip"
                                                data-placement="bottom" title="Form name here" value="{{ $form['name'] }}" required autocomplete="name" autofocus="name">
                                            <span class="bar"></span>
                                        ...
                                        <div class="form-group mb-4">
                                            <input type="text" name="alias" class="form-control @error('alias') is-invalid @enderror" id="alias" data-toggle="tooltip"
                                                data-placement="bottom" title="Alias e.g. F1" value="{{ $form['alias'] }}" required autocomplete="alias" autofocus="alias">
                                            <span class="bar"></span>
