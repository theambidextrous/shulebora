            ...
            <div class="d-flex mt-2 justify-content-end">
                <div class="d-flex mr-3 ml-2">
                    <div class="chart-text mr-2">
                        <a href="{{ route('admin.groups') }}" class="btn btn-info"><i class="mdi mdi-library-plus"></i> Back</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card blog-widget">
                    <div class="card-body">
                        <div class="d-flex flex-wrap">
                            <div><h3 class="card-title">Update Group</h3></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="card-body" style="width:100%!important;">
                                ...
                                <form class="floating-labels mt-4" method="POST" action="{{ route('admin.update_group', ['id' => $group['id']]) }}">
                                    @csrf
                                    <div class="form-group mb-4">
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" data-toggle="tooltip"
                                            data-placement="bottom" title="group name here" value="{{ $group['name'] }}" required autocomplete="name" autofocus="name">
                                        <span class="bar"></span>
