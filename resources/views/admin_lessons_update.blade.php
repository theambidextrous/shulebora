            ...
            <div class="d-flex mt-2 justify-content-end">
                <div class="d-flex mr-3 ml-2">
                    <div class="chart-text mr-2">
                        <a href="{{ route('admin.lessons') }}" class="btn btn-info"><i class="mdi mdi-library-plus"></i> Back</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card blog-widget">
                    <div class="card-body">
                        <div class="d-flex flex-wrap">
                            <div><h3 class="card-title">Manage Lesson</h3></div>
                        </div>
                            ...
                            <div class="card-body" style="width:100%!important;">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="home">
                                        <!-- form -->
                                        <br>
                                        <form class="mt-4" enctype="multipart/form-data" method="POST" action="{{ route('admin.update_lesson', ['id'=>$lesson['id']]) }}">
                                            @csrf
                                            <!-- row bgn -->
                                            <div class="row">
                                                <div class="col-md-4">
                                    ...
                                    <div class="tab-pane" id="profile">
                                        <!-- form -->
                                        <br>
                                        <form class="mt-4" method="POST" action="{{ route('admin.update_student_access', ['id'=>$lesson['id']]) }}">
                                            @csrf
                                        </form>
                                        <!-- end form -->
                                    </div>
