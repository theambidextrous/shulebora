                                    ...
                                    <div class="tab-pane show active" id="home">
                                        ...
                                        <form class="floating-labels mt-4" enctype="multipart/form-data" method="POST" action="{{ route('admin.update_package',['id'=>$package['id']]) }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        <input type="number" name="max_usage" class="form-control @error('max_usage') is-invalid @enderror" id="max_usage" data-toggle="tooltip" data-placement="bottom" title="duration here e.g. " value="{{ $package['max_usage'] }}" required autocomplete="max_usage" autofocus="max_usage">
                                                        <span class="bar"></span>
