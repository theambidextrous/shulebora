            ...
            <div class="d-flex mt-2 justify-content-end">
                <div class="d-flex mr-3 ml-2">
                    <div class="chart-text mr-2">
                        <a href="#" data-toggle="modal" data-target="#new_Subject_modal" class="btn btn-info"><i class="mdi mdi-library-plus"></i> Add Subject</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
                ...
                <div class="card blog-widget">
                    <div class="card-body">
                        <div class="d-flex flex-wrap">
                            <div><h3 class="card-title">{{$p_title??'All Subjects'}}</h3></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="card-body" style="width:100%!important;">
                                <h6 class="card-subtitle">List of all subjects from across all forms and classes</a></h6>
                                <div class="table-responsive">
                                    <table style="width:100%!important;" id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            ...
                                            @php($status = ($subject['is_active'] == 1) ? 'Active':'Inactive')
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $form_or_class }}</td>
                                                <td>{{$status}}</td>
                                                <td><a href="{{ url('shule/bora/admin/subjects/' . $subject['id']) }}" class="btn btn-link"><i class="mdi mdi-table-edit"></i>Manage</a></td>
                                            </tr>
                                            @endforeach
                                            @endif
                                        </tbody>
        ...
        <div id="new_Subject_modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form class="floating-labels mt-4" method="POST" action="{{ route('admin.add_subject') }}">
                            @csrf
                            <div class="form-group mb-4">
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" data-toggle="tooltip"
                                    data-placement="bottom" title="Subject name here" value="{{ old('name') }}" required autocomplete="name" autofocus="name">
                                <span class="bar"></span>
