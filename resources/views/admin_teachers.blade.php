        ...
        <div class="col-md-7 col-12 align-self-center d-none d-md-block">
            <div class="d-flex mt-2 justify-content-end">
                <div class="d-flex mr-3 ml-2">
                    ...
                    <a href="#" data-toggle="modal" data-target="#new_teacher_modal" class="btn btn-info"><i class="mdi mdi-library-plus"></i> Add Teacher</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
                ...
                <div class="card blog-widget">
                    <div class="card-body">
                        <div class="d-flex flex-wrap">
                            <div><h3 class="card-title">All Teachers</h3></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="card">
                            <div class="card-body">
                                <h6 class="card-subtitle">List of all teachers at {{config('app.name')}}. Includes teachers across all classes and all forms</a></h6>
                                    ...
                                    <table style="width:100%!important;" id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$teacher['email']}}</td>
                                                <td>{{$teacher['phone']}}</td>
                                                <td>{{date('M jS, Y',strtotime($teacher['created_at']))}}</td>
                                                <td><a href="{{ url('shule/bora/admin/teachers/' . $teacher['id']) }}" class="btn btn-link"><i class="mdi mdi-table-edit"></i>Manage</a></td>
                                            </tr>
                                            @endforeach
                                            @endif
                                        </tbody>
        ...
        <div id="new_teacher_modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="text-center mt-2 mb-4">
                            ...
                            <h2 class="modal-h2">Create Teacher Account</h2>
                        </div>
                        <form class="floating-labels mt-4" method="POST" action="{{ route('admin.add_teacher') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <!-- input -->
