        ...
        <div class="col-md-5">
            ...
            <div class="card" style="background:transparent;">
                ...
                <div class="card-body">
                    ...
                    <div style="display:none;" id="action"><a href="{{route('corporate')}}" class="btn btn-info">Click here to Complete</a></div>
                    ...
                    @if(session('mpesa'))
                        ...
                        <!-- <div class="alert alert-info">{{session('mpesa.a')}}</div>
                    ...
                    <form class="mt-2 col-md-12" method="POST" action="{{route('corp_pay')}}">
                    ...
                    <a style="padding-left:4px;" href="{{route('corporate')}}">  Try again Here</a></p>
