    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-xlg-12 col-md-12">
                <div class="card">
                <a class="nav-link active tm-lg" id="pills-timeline-tab" data-toggle="pill" href="#current-month" role="tab" aria-controls="pills-timeline" aria-selected="true"><i class="mdi mdi-book-open-page-variant"></i> Free Notes </a>
                        ...
                        <div id="collapseOne{{$_sub['id']}}" class="collapse {{$show}}" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-justify">
                                    <a href="{{route('finder',['file'=>$_sub['file_content']])}}" target="_blank" download><i class="mdi mdi-file-pdf"></i> Download</a>
                                </p>
                                @endif
                           </div>
                        </div>
