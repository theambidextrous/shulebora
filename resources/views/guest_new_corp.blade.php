    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- form -->
                    <form class="floating-labels mt-4" method="POST" action="{{ route('corporate_create') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                 <!-- input -->
                                 <div class="form-group mb-5">
                                    <input type="text" name="school" class="form-control @error('school') is-invalid @enderror" id="school" data-toggle="tooltip"
                                        data-placement="bottom" title="e.g. Kenya High School" value="{{ old('school') }}" required autocomplete="school" autofocus="school">
                                    <span class="bar"></span>
                                    <label for="school">Organization Name</label>
                                    @error('school')
