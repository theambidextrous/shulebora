        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-xlg-7 col-md-7">
                ...
                <div class="card">
                    ...
                    <a class="nav-link active tm-lg" id="pills-timeline-tab" data-toggle="pill" href="#current-month" role="tab" aria-controls="pills-timeline" aria-selected="true"><i class="icon-book-open"></i> Topical Questions</a>
                    ...
                    @foreach( $assignments as $assignment )
                        ...
                        <h4>({{$ll}}) {{$assignment['title']}}</h4>

                        <h6>{{$assignment['content']}}</h6>

                        <small class="text-muted">

                        <i class="icon-book-open"></i> {{App\Subject::find($assignment['subject'])->name}} 

                        <i class="icon-clock"></i> {{ date('M jS, Y', strtotime($assignment['created_at'])) }}
