    ...
    <div class="row page-titles">
        ...
        <div class="col-md-5 col-12 align-self-center">
            ...
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('teacher.assignments') }}">Topical Questions</a></li>
            ...
            <div class="d-flex mt-2 justify-content-end">
                ...
                <div class="d-flex mr-3 ml-2">
                    ...
                    <div class="chart-text mr-2">
                        ...
                        <a href="{{ route('teacher.assignments') }}" class="btn btn-info"><i class="mdi mdi-library-plus"></i> Topical Questions</a>
                ...
                <div class="card blog-widget">
                    ...
                    <div class="card-body">
                        ...
                        <div class="list-group"> 
                            ...
                            <a href="{{ route('teacher.assignments') }}" class="list-group-item active">Topical Questions</a>
                ...
                <div class="card blog-widget">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div><h3 class="card-title">Manage Topical Question</h3></div>
