...
<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        ...
        <ol class="breadcrumb mb-0 p-0 bg-transparent">
            ...
            <li class="breadcrumb-item"><a href="{{ route('teacher') }}">Admin</a></li>
            <li class="breadcrumb-item"><a href="{{ route('teacher.papers') }}">papers</a></li>
        ...
        <div class="d-flex mt-2 justify-content-end">
            <div class="d-flex mr-3 ml-2">
                <div class="chart-text mr-2">
                    <a href="{{ route('teacher.papers') }}" class="btn btn-info"><i class="mdi mdi-library-plus"></i> Paper</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body" style="width:100%!important;">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="home">
                                    <!-- form -->
                                    <br>
                                    <form class="floating-labels mt-4" enctype="multipart/form-data" method="POST" action="{{ route('teacher.update_paper', ['id'=>$paper['id']]) }}">
                                    @csrf
                                    <!-- row bgn -->
                                    <div class="row">
                                        <div class="col-md-6">
