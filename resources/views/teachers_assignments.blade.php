                                    ...
                                    <table style="width:100%!important;" id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{ url('shule/bora/teacher/assignments/' . $assignment['id']) }}" class="btn btn-link"><i class="mdi mdi-table-edit"></i>Manage</a></td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-center mt-2 mb-4">
                            ...
                            <a href="{{route('teacher')}}" class="text-success">
                        ...
                        <form class="floating-labels mt-4" enctype="multipart/form-data" method="POST" action="{{ route('teacher.add_assignment') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <textarea style="background: #e6e2e2;" rows="5" name="content" class="form-control @error('content') is-invalid @enderror" id="content"></textarea>
